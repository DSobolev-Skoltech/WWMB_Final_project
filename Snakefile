...
# define directories
#\\wsl.localhost\Ubuntu\home\nagibator111\MMB\phage_variant_calling_18_01_2023\data\reference
reference_dir = os.path.join('data', 'reference')
#\\wsl.localhost\Ubuntu\home\nagibator111\MMB\phage_variant_calling_18_01_2023\data\raw_reads
raw_reads_dir = os.path.join('data', 'raw_reads')
#\\wsl.localhost\Ubuntu\home\nagibator111\MMB\phage_variant_calling_18_01_2023\mapped
mapped_dir = os.path.join('mapped')
#\\wsl.localhost\Ubuntu\home\nagibator111\MMB\phage_variant_calling_18_01_2023\mapped_sorted
sorted_dir = os.path.join('mapped_sorted')
#\\wsl.localhost\Ubuntu\home\nagibator111\MMB\phage_variant_calling_18_01_2023\calling
